...
SumEventsRec := RECORD
 ...
 UNSIGNED4 EvtSevRat := SUM(GROUP,(SevTbl.SevCnt * (7 -SevTbl.SevCode))/SevTbl.SevCnt); // This is the weighted sum of the weather events taking the severity code into account
...
OUTPUT(SumEventTbl,,'~TeamBelievers::Hack::Output::WeatherScores',NAMED('WeatherEvents'),OVERWRITE);